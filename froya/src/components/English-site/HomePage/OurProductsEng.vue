<template>
    ...
    <div class="mb-5">
        <h3 class="text-wrap text-lg-start px-3" >Our products</h3>
        <p class="text-wrap text-lg-start px-3" style="max-width: 60%;">
        It's no secret that the environment is important.
        The marine environment around the island of Frøya forms an ideal 
        basis for marine diversity and is among the best in the world. 
        </p>
    </div>
