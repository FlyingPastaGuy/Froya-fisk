                            ...
                            <tr v-for="(product,i) in producktArray" :key="i">
                                ...
                                <td>
                                    <div class="input-group mb-3 justify-content-center">
                                        ...
                                        <input type="text" :placeholder="product.ProductAmount" class="length text-center text text-outline-secondary w-25" aria-label="Disabled input" disabled readonly>
