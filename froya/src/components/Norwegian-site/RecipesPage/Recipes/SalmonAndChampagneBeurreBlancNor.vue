...
<div class="bg-white">
    <article class="container py-5 my-5">
        <h2 class="text-black">Laks og champgne beurre blanc</h2>
        <p>
            Pannestekt laks med champgne beurre blanc, aspargesbønner og hasselback
            poteter
        </p>
            <div class="row">
                <div class="col">
                    ...
                    <h6>Saus: Beurre Blanc med champgne</h6>
                    <ul>
                        <li>
                            <p>50 gram smør</p>
                        </li>
            ...
            <div class="row mt-5">
                <div class="col">
                    <h6>Fremgangsmåte</h6>
                    <p>Saus: Beurre Blanc med champgne</p>
                    <ol>
                        <li>
                            <p> 
