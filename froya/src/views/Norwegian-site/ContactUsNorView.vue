        ...
        <article class="container py-5 my-5 ">
            <div class="row">
                <div class="col">
                    ...
                    <p>Salg & Markedsføring</p>
                    <p>Oslo Fiskehall,</p>
                    <p>akerhusstrande 23</p>
                    <p>0150 Oslo</p>

                        <div>
                            <h3>Email</h3>
                            <p>post@froyasalmon.no</p>
                        </div>
                        <div>
                            <h3>Hovedkontor</h3>
                            <p class="pt-4">Havet 45</p>
                            <p>8370 Leknes</p>
                            <p class="pt-4">+47 45634390</p>
                        </div>
                </div>
                <div class="col">
                    <h2>Lurer du på noe? Send oss en melding</h2>
